...
AdvisorQuoteBuildSelectProductStatusDetail(status) {
    return "result=" AdvisorQuoteStatusValue(status, "result")
        ...
        . ", currentAddressSource=" AdvisorQuoteStatusValue(status, "currentAddressSource")
        . ", currentAddressSelectedIndex=" AdvisorQuoteStatusValue(status, "currentAddressSelectedIndex")
        . ", currentAddressText=" AdvisorQuoteStatusValue(status, "currentAddressText")
