...
ReadConfigSnapshot() {
    ...
    cfg["agentName"] := IniRead(settingsFile, "Agent", "Name", "Example Agent")
    cfg["agentEmail"] := IniRead(settingsFile, "Agent", "Email", "agent@example.com")
    ...
    cfg["phoneLine"] := TemplateRead("QuoteMessage", "PhoneLine", "(555) 010-0100")
    cfg["signatureTitle"] := TemplateRead("QuoteMessage", "SignatureTitle", "Agente de Seguros - Allstate")
    cfg["directLine"] := TemplateRead("QuoteMessage", "DirectLine", "Direct Line: (555) 010-0100")
    cfg["officeLine"] := TemplateRead("QuoteMessage", "OfficeLine", "Office Line: (555) 010-0101")
