...
BuildQuoteMessageTokens(leadName, carCount, vehicles := "", useBatchPricingRules := false) {
    ...
    return Map(
        ...
        "PHONE_LINE", TemplateRead("QuoteMessage", "PhoneLine", "(561) 220-7073"),
        "AGENT_NAME", agentName,
        "SIGNATURE_TITLE", TemplateRead("QuoteMessage", "SignatureTitle", "Agente de Seguros - Allstate"),
        "DIRECT_LINE", TemplateRead("QuoteMessage", "DirectLine", "Direct Line: (561) 220-7073"),
        "OFFICE_LINE", TemplateRead("QuoteMessage", "OfficeLine", "Office Line: (754) 236-8009"),
